...
class __TwigTemplate_d1dcac4d53475c967f915eaf29024c1f662d50857ebe0a311956741387a31e54 extends Twig_Template
{
    ...
    {
        return new Twig_Source("{# inline_template_start #}{% trans %}{{ date }} by {{ username }}{% endtrans %}{% if message %}<p class=\"revision-log\">{{ message }}</p>{% endif %}", "{# inline_template_start #}{% trans %}{{ date }} by {{ username }}{% endtrans %}{% if message %}<p class=\"revision-log\">{{ message }}</p>{% endif %}", "");
    }
}
